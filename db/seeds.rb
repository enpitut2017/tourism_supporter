Spot.create!(placeName:  "筑波大学嘉納治五郎像",
             detailComment: '嘉納治五郎先生は1860年12月に生まれ、東京帝国大学を卒業後、講道館柔道を創設しました。
...
Spot.create!(placeName:  "附属病院けやき棟から",
             detailComment: '比較的高い棟であるため、非常に眺めがよく、写真撮影にも適しています。筑波大の隠れスポットです。',
             lat: 36.092247,
             lng: 140.102209,
             picture: open("#{Rails.root}/public/sampletsukuba.jpg"))

Spot.create!(placeName:  "一の矢エリアの並木道",
             detailComment: '一の矢エリアは筑波大の自然の多さを体感することができます。
